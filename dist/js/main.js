...
document.querySelector('.close-modal').addEventListener('click', function () {
  micromodal__WEBPACK_IMPORTED_MODULE_0__["default"].close('modal');
});
...
var swiperAdvantages = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".slider-advantages", {
  slidesPerView: "auto",
  spaceBetween: 40,
  navigation: {
...
var swiperGallery = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".gallery-slider", {
  slidesPerView: "auto",
  spaceBetween: 24,
  navigation: {
    nextEl: ".gallery-next",
...
if (screenWidth < 768) {
  var videoContainer = document.querySelector('.video-nav'),
  ...
  videoSlide.forEach(function (item) {
    item.classList.add('swiper-slide');
  });
  var swiperVideo = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".video-nav", {
    direction: 'vertical',
    slidesPerView: 1,
    spaceBetween: 12,
    navigation: {
...
tabVideo.forEach(function (item, i) {
  item.addEventListener("click", function (e) {
    e.preventDefault();
    var tabName = this.dataset.video,
...
var scrollTo = document.querySelectorAll("a.js-scroll-to");

var _iterator = _createForOfIteratorHelper(scrollTo),
    _step;

try {
  var _loop = function _loop() {
    var scroll = _step.value;
...
var toUpBtn = document.getElementById('to-up');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_modal_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! %components%/modal/modal */ "./src/blocks/components/modal/modal.js");
